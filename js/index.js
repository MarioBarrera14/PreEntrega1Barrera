...
function convertir(){
    ...
    if(document.getElementById("uno").checked){
        ...
        alert ("EL cambio de peso a dolar es: $"+resultado.toFixed(2));
    }else if(document.getElementById("dos").checked){
        resultado=valore*euro;
        alert ("El cambio de peso a euro es: $"+resultado.toFixed(2));
    }else if(document.getElementById("tres").checked){
        resultado=valore*pesoChileno;
        alert ("El cambio de peso a peso chileno es: $"+resultado.toFixed(2));
